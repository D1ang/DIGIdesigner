...
function brandSelector() {
	document.getElementById('shirt').src = 'assets/svg/asics-shirt.svg';
...
function activateColour() {
  ...
  var i = colourOption.selectedIndex;
	...
	document.getElementById('fill--inject-1').style.fill = document.getElementById('colour').getElementsByTagName('option')[i].text;
}
